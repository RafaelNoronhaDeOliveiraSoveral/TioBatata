...
export default function Mago() {
    ...
    useEffect(() => {
        const getMediaUrls = async () => {
            // Get the references
            let imgListRef = ref(storage, 'imagens/mago');
            let videoListRef = ref(storage, 'videos/mago'); // Assuming 'videos' is the directory for videos
    ...
    return (
        <>
            <Head>
                <title>Tio Batata: Mago</title>
            </Head>
            <NavMinima toggleContent={toggleContent} titulo={"MAGO"} />
